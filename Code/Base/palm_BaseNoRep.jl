...
epsilon = 0.001
outfile = "./Output/BaseNoRep"*myInstance*"_"*myRun*".txt"
...
# f = open(outfile, "w")
# println(f,"Optimality gap myTest = ", opt_gap)
...
timesFile = open("/Users/din/Documents/July2020Paper1/Summary/local_BaseNoRep.txt", "a")
