...
epsilon = 0.001
outfile = "./Output/BaseScore"*myInstance*"_"*myRun*".txt"
...
#             if k == 22
#                 f = open(outfile, "a")
#                     println(f,"O.C.1 Check Cell ", k, ": ", SP, "; con_num = ", row)       
#                 close(f)
#             end
#                     else
#                         c_L = cL_orig[:,1] 
...
#             f = open(outfile, "a")
#                 println(f,"OC1. Cell ", k, ": ", z_now[k], " ", g[k])       
#             close(f)
...
#                         f = open(outfile, "a")
#                             println(f,"M_max = ", M_max, "; M_min = ", M_min)
#                         close(f)
                    if M_max/M_min > 10
#                             f = open(outfile, "a")
#                                 println(f,"Pick Max")
...
#                     if newCell == 22
#                         f = open(outfile, "a")
#                             println(f,"O.C.2 Check Cell ", k, ": ", g[k], "; con_num = ", con_num)       
#                         close(f)
#                     end
...
timesFile = open("/Users/din/Documents/July2020Paper1/Summary/local_BaseScore.txt", "a")
