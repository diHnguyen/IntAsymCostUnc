...
epsilon = 0.001
outfile = "./Output/BaseSAPath"*myInstance*"_"*myRun*".txt"
gurobi_env = Gurobi.Env()

to = TimerOutput()
myFile = "./Instances/15NodesPrelim_"*myInstance*".jl"
# myFile = "myData5_Nominal.jl"
include(myFile)
# include("myData10.jl")
    ...
    if x_count == 10 #===SA-Loop===#
        ...
        for k = 1:myLength #===SA.1.1===#
            if (k in checkedCells) == false #===SA.1.1.1===#
                ...
                remainingArcs = find(Delta_Final_Neg.== -1)
...
timesFile = open("/Users/din/Documents/July2020Paper1/Summary/local_BaseSAPath.txt", "a")
