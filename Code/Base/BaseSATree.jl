...
epsilon = 0.001
outfile = "./Output/BaseSATree"*myInstance*"_"*myRun*".txt"
...
@timeit to "CALC OPT GAP" opt_gap =MP_obj - sum(p[i]*(h[i]) for i = 1:length(p))
...
timesFile = open("/Users/din/Documents/July2020Paper1/Summary/local_BaseSATree.txt", "a")
