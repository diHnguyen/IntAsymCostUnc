...
epsilon = 0.001
outfile = "./Output/MulticutMultipartitionSATree"*myInstance*"_"*myRun*".txt"
...
#                 while k < myLength #for k = 1:myLength#cell_num in Cell_List
        for k = 1:myLength #SA.1#
            if (k in checkedCells) == false #SA.1.1#
#                     k=k+1
...
timesFile = open("/Users/din/Documents/July2020Paper1/Summary/local_MulticutMultipartitionSATree.txt", "a")
