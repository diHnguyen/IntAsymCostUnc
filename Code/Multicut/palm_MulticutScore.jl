...
epsilon = 0.001
outfile = "./Output/MulticutScore"*myInstance*"_"*myRun*".txt"
...
#                                 println("i = ", i)
                    ...
                    found = true
#                     f = open(outfile, "a")
#                         println(f,"Split Candidate ",split_Candidates)
#                     close(f)
...
timesFile = open("/Users/din/Documents/July2020Paper1/Summary/local_MulticutScore.txt", "a")
