...
epsilon = 0.001
outfile = "./Output/MulticutWeighted"*myInstance*"_"*myRun*".txt"
...
#                 println(f,"\nCURRENT CELL = ", k)
    ...
    #                     println("Add g-h cut at cell ", k)
        ...
        end#while found == false && t < myLength
...
timesFile = open("/Users/din/Documents/July2020Paper1/Summary/local_MulticutWeighted.txt", "a")
